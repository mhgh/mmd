...
(function(addon) {
    ...
    UI.component('htmleditor', {
        ...
        defaults: {
            ...
            toolbar      : [ 'bold', 'italic', 'strike', 'link', 'image', 'blockquote', 'listUl', 'listOl' , 'FCB', 'CDIR'],
            lblPreview   : 'Preview',
            lblCodeview  : 'HTML',
    ...
    UI.components.htmleditor.template = [
        '<div class="uk-htmleditor uk-clearfix" data-mode="split">',
            ...
            '<div class="uk-htmleditor-content">',
                ...
                '<div class="uk-htmleditor-preview" id="htmleditor-Preview"><div></div></div>',
            '</div>',
        '</div>'
    ].join('');
    ...
    UI.plugin('htmleditor', 'base', {
        ...
        init: function(editor) {
            ...
            editor.addButtons({
                ...
                CDIR : {
                    title  : 'RTL <--> LTR',
                    label  : '<i class="uk-icon-arrows-h"></i>'
                },                    
            ...
            editor.on('action.CDIR', function() {
                if(input_direction_ltr){        
                    $(".CodeMirror-wrap").map(function(e) { $(this).attr( "style","direction:rtl"); });  
                    input_direction_ltr = false;
                }else{
                    $(".CodeMirror-wrap").map(function(e) { $(this).attr( "style","direction:ltr"); }); 
                    input_direction_ltr = true;
                }
            });            
